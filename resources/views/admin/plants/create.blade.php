            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('admin.plants.store') }}" enctype="multipart/form-data">
                        ...
                        <!-- Gambar -->
                        <div class="mt-4">
                            <x-input-label for="image_url" value="Foto Tanaman" />
                            <input id="image_url" type="file" name="image_url" class="block mt-1 w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 focus:outline-none" required accept="image/*">
